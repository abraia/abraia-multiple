...
def restore_poly(instance_yxs_list, seq_strs, p_border, shape_ratio, image_size, valid_set):
    offset_expand = 1.2 if valid_set == "totaltext" else 1.0
    ratio_h, ratio_w = shape_ratio
